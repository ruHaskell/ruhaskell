...
tags: types, typeclasses, heterogeneous lists
description: Использование гетерогенных списков. Фильтрация по классам типов. Вызов соответствующих функций. Реализация концепции instanceOf и asInstanceOf
---
...
Время и усилия были не напрасны в плане погружения в хаскель, но больше всего радует то, что поставленная задача решена.
Пусть пока грубо, пусть только для нашего конкретного случая.

## Решение задачи

Хаскель по своей сути является функциональным языком программирования.
...
Для пущей убедительности в том, что всё работает, сделаем объекты проекта "мультинаследуемыми".
...
Представим схему функциональности в виде небольшого списка, который показывает какой класс каким типом инстанциируется:
...
(Не забывайте, хаскель после компиляции полностью забывает про классы.)
...
Однако, каждый раз я заходил в тупик. Хаскель ревностно защищает свою систему типов и жёстко пресекает все попытки её (защиту) обойти.

Буду рад, если эта статья окажется кому-то полезной.

## Список использованных в процессе подготовки материалов

[Typeclass example · GitHub](https://gist.github.com/orionll/0f60e891fe7ac306a002)

[haskell - Use of &#39;unsafeCoerce&#39; - Stack Overflow](https://stackoverflow.com/questions/22847740/use-of-unsafecoerce)

[ghc - Unsafe entailment with Haskell constraints - Stack Overflow](https://stackoverflow.com/questions/32481418/unsafe-entailment-with-haskell-constraints)

[unsafe entailment with haskell constraints www.tutel.me](https://www.tutel.me/c/programming/questions/32481418/unsafe+entailment+with+haskell+constraints)

[turning a dict into a constraint](https://www.tutel.me/c/programming/questions/29482576/turning+a+dict+into+a+constraint)

[Toy instructional example of Haskell GADTs: simple dynamic types. · GitHub](https://gist.github.com/sacundim/5386823)

[OOHaskell - 0509027.pdf](https://arxiv.org/pdf/cs/0509027.pdf)

[OOP in Haskell: implementing wxHaskell in Haskell](http://www.rubendegooijer.nl/posts/2013-04-06-haskell-oop.html)

[Object-Oriented Style Overloading for Haskell - Microsoft Research](https://www.microsoft.com/en-us/research/publication/object-oriented-style-overloading-for-haskell)

[encapsulation, mutable state, inheritance, overriding, statically checked implicit and explicit subtyping, and so on](https://arxiv.org/abs/cs/0509027)

[nkaretnikov/OOHaskell · GitHub](https://github.com/nkaretnikov/OOHaskell/blob/master/samples/CircBuffer.hs OOHaskell/CircBuffer.hs)

[oo-haskell/Store.hs at master · andorp/oo-haskell · GitHub](https://github.com/andorp/oo-haskell/blob/master/src/Store.hs)

[newtype Monoid example haskell - Use of &#39;unsafeCoerce&#39; - Stack Overflow](https://stackoverflow.com/questions/22847740/use-of-unsafecoerce)

[haskell - How to put constraints on the associated data? - Stack Overflow](https://stackoverflow.com/questions/11258536/how-to-put-constraints-on-the-associated-data)
...
[typeclass - How do I make an heterogeneous list in Haskell? (originally in Java) - Stack Overflow](https://stackoverflow.com/questions/20997745/how-do-i-make-an-heterogeneous-list-in-haskell-originally-in-java)

[haskell - ConstraintKinds explained on a super simple example - Stack Overflow](https://stackoverflow.com/questions/31317159/constraintkinds-explained-on-a-super-simple-example)

[OOP vs type classes - HaskellWiki](https://wiki.haskell.org/OOP_vs_type_classes)

[Heterogenous collections - HaskellWiki](https://wiki.haskell.org/Heterogenous_collections)

[How to work on lists - HaskellWiki](https://wiki.haskell.org/How_to_work_on_lists)

[Some interesting features of Haskell’s type system | Wolfgang Jeltsch](https://jeltsch.wordpress.com/2013/02/09/some-interesting-features-of-haskells-type-system/)

[Typeable and Data in Haskell](http://chrisdone.com/posts/data-typeable)

[GHC/Type families - HaskellWiki](https://wiki.haskell.org/GHC/Type_families#Detailed_definition_of_type_synonym_families)

[introspection - Get a list of the instances in a type class in Haskell - Stack Overflow](https://stackoverflow.com/questions/5396783/get-a-list-of-the-instances-in-a-type-class-in-haskell)

[7.12. The Constraint kind](https://downloads.haskell.org/~ghc/7.8.4/docs/html/users_guide/constraint-kind.html)

[Typeclasses: Polymorphism in Haskell - Andrew Gibiansky](http://andrew.gibiansky.com/blog/haskell/haskell-typeclasses/#_converting_between_numeric_types)

[Tagging functions in Haskell - Stack Overflow](https://stackoverflow.com/questions/20576596/tagging-functions-in-haskell/20576712#20576712)

[haskell - AllowAmbiguousTypes and propositional equality: what&#39;s going on here? - Stack Overflow](https://stackoverflow.com/questions/27008046/allowambiguoustypes-and-propositional-equality-whats-going-on-here)

[24 Days of GHC Extensions: Type Families](https://ocharles.org.uk/blog/posts/2014-12-12-type-families.html)

[GHC/AdvancedOverlap - HaskellWiki](https://wiki.haskell.org/GHC/AdvancedOverlap)

[haskell - How can I read the metadata of a type at runtime? - Stack Overflow](https://stackoverflow.com/questions/28243383/how-can-i-read-the-metadata-of-a-type-at-runtime)

[Reflecting values to types and back - School of Haskell | School of Haskell](https://www.schoolofhaskell.com/user/thoughtpolice/using-reflection)

[Type Families and Pokemon. - School of Haskell | School of Haskell](https://www.schoolofhaskell.com/school/to-infinity-and-beyond/pick-of-the-week/type-families-and-pokemon)
